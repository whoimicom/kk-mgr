package com.whoimi.config.session;
 ...
 */
@Component
public class SessionInformationExpiredWiiImpl implements SessionInformationExpiredStrategy {
    private static final Logger logger = LoggerFactory.getLogger(SessionInformationExpiredWiiImpl.class);
