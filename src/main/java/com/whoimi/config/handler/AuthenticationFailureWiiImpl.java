 ...
 */
@Component
public class AuthenticationFailureWiiImpl implements AuthenticationFailureHandler {
    private static final Logger logger = LoggerFactory.getLogger(AuthenticationFailureWiiImpl.class);
