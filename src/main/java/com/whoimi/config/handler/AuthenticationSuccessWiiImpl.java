 ...
 */
@Component
public class AuthenticationSuccessWiiImpl implements AuthenticationSuccessHandler {
    private final Logger logger = LoggerFactory.getLogger(AuthenticationSuccessWiiImpl.class);
    private ObjectMapper mapper = new ObjectMapper();
    private RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();
    private RequestCache requestCache = new HttpSessionRequestCache();
    private SessionRegistry sessionRegistry;

    public AuthenticationSuccessWiiImpl() {
        super();
    }

    public AuthenticationSuccessWiiImpl(SessionRegistry sessionRegistry) {
